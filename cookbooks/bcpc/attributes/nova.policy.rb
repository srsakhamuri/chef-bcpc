...
default['bcpc']['nova']['policy'] = {
  ...
  "os_compute_api:server-metadata:index" => "role:admin_or_owner",
  "os_compute_api:server-metadata:show" => "role:admin_or_owner",
  "os_compute_api:server-metadata:delete" => "role:admin_or_owner",
  "os_compute_api:server-metadata:create" => "role:admin_or_owner",
  "os_compute_api:server-metadata:update" => "role:admin_or_owner",
  "os_compute_api:server-metadata:update_all" => "role:admin_or_owner",
